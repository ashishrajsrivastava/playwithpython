...
b6 = Button(master, text = "Polution Level", background="#00a9e0")
b7 = Button(master, text = "Polution Level", background="#00a9e0")
b8 = Button(master, text = "Polution Level", background="#00a9e0")
b9 = Button(master, text = "Polution Level", background="#00a9e0")
b10 = Button(master, text = "Polution Level", background="#00a9e0")
b11 = Button(master, text = "Polution Level", background="#00a9e0")
b12 = Button(master, text = "Polution Level", background="#00a9e0")
b13 = Button(master, text = "Polution Level", background="#00a9e0")
b14 = Button(master, text = "Polution Level", background="#00a9e0")
b15 = Button(master, text = "Polution Level", background="#00a9e0")
#arranging buttons
